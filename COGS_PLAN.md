...
**Status:** **All phases complete.** Phases 1–3 implemented 2026-08-03 (app code); **Phase 0 executed 2026-08-05** — historical COGS backfilled and anchored to the filed tax returns per the user's "match filed COGS exactly" decision: 2024 books $127,155 and 2025 books $287,899 of COGS (the filed figures), Dec-31 inventory equals the filed $7,200 / $12,150 to the penny, and the book-vs-filed purchases difference ($2,420 / $2,266.76) sits in Dec-31 reclass pairs to Business Expenses. Filed ratios came out ≈ 83.4% / 83.2% of revenue — corroborating the client's 20% markup. 2026 runs on monthly estimates (Jan–Jun at 83.33% of deposit revenue; Jul onward booked by the app at the UI's `cogs_method` ratios) until the **≈ Sep 2026 first count** trues up Q3; the Dec 31 2026 count aligns the next filing. Open question: the UI ratios are set to 80 (a 20%-*margin* reading) while the tax data supports 83.3 (20% *markup*).

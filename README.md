...
Routes: `/` (Dashboard) · `/transactions` · `/pl` · `/buys` · `/accounts` · `/square`
...
4. Log any cash buys from shows on **Inventory Buys**.
5. Update the cash balance on the **Dashboard** runway card.

The "Monthly Close" card on the dashboard tracks steps 1–3 automatically.
